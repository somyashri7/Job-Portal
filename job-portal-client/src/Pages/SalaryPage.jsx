...
console.log(searchText)
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      ...
      {/* salary displaying part(card) */}
      <div className='grid lg:grid-cols-3 grid-cols-1 gap-12 my-12 items-center'> 
        {
          salary.map((data) => (
            <div key={data.id} className='shadow px-4 py-8 '>
              <h4 className='font-semibold text-xl'>{data.title}</h4>
              <p className='my-2 font-medium text-blue-400 text-lg'>{data.salary}</p>
